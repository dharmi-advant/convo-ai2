...
const buttonVariants = tv({
  base: [
    // base
    'relative inline-flex items-center justify-center whitespace-nowrap rounded-md border mb-10 ml-3px-3 py-2 text-center text-sm font-medium shadow-xs transition-all duration-100 ease-in-out',
    // disabled
  ...
  variants: {
    variant: {
      primary: [
        ...
        // background color
        'bg-gray-600 -500 dark:bg-blue-500',
        // hover color
        'hover:bg-gray-700 dark:hover:bg-blue-600',
        // disabled
